...
const RestaurantForm = () => {
    ...
    // }
        ...
        const handleSubmitForm = async (e)=>{
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_REACT_APP_BASE_URL}/restaurants/create-restaurant`, {
                method:"POST",
                headers:{
  ...
  return (
    <section className='admin-page'>
        ...
        <h2 className='container-heading'>Fill in with Your Restaurant Information Here</h2>
